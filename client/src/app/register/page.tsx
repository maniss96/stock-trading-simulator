...
import { User, Lock, Mail, TrendingUp, Eye, EyeOff, Check } from 'lucide-react';
      ...
      >
        <GlassCard variant="lg" glow="primary">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-400 mt-1">Start trading with $100,000 in virtual funds</p>
          </div>
                ...
                {passwordChecks.map((check) => (
                  <div
                    ...
                    className={cn(
                      ...
                      check.check ? 'text-accent-400' : 'text-gray-500'
                    )}
                  >
                    <Check className={cn('w-3 h-3', check.check ? 'opacity-100' : 'opacity-30')} />
                    {check.label}
                  </div>
                ))}
              </div>
